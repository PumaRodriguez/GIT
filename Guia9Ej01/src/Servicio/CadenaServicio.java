...
public class CadenaServicio {
    ...
    Cadena c1 = new Cadena();
        System.out.println("\u001B[35m" + "Ingrese la frase: ");
...
//Método vecesRepetido(String letra), recibirá un carácter ingresado por el usuario 
    ...
    //longitud de la frase que compone la clase con otra nueva frase ingresada
    //por el usuario.
    ...
    public void compararLongitud(Cadena c1){
        ...
        if (c1.getFrase().length() == frase.length()) {
            ...
            System.out.println("No son iguales, segui participando");
        }
    }
